...
{
    /**
     * @var \SGPhule\BookStoreApp\Controller\TopicController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\SGPhule\BookStoreApp\Controller\TopicController::class)
    ...
    public function listActionFetchesAllTopicsFromRepositoryAndAssignsThemToView()
    {
        ...
        $topicRepository = $this->getMockBuilder(\SGPhule\BookStoreApp\Domain\Repository\TopicRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $topic = new \SGPhule\BookStoreApp\Domain\Model\Topic();
