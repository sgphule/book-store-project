...
{
    /**
     * @var \SGPhule\BookStoreApp\Controller\PublisherController
     */
    ...
    {
        parent::setUp();
        $this->subject = $this->getMockBuilder(\SGPhule\BookStoreApp\Controller\PublisherController::class)
    ...
    public function listActionFetchesAllPublishersFromRepositoryAndAssignsThemToView()
    {
        ...
        $publisherRepository = $this->getMockBuilder(\SGPhule\BookStoreApp\Domain\Repository\PublisherRepository::class)
            ->setMethods(['findAll'])
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        $publisher = new \SGPhule\BookStoreApp\Domain\Model\Publisher();
